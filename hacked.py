...
# -*- coding: utf-8 -*-
        ...
        #############################################
        #                                           #
        #    ALL FACEBOOK  FAST AND REAL TARGET ID CLON   #
        #    pehle apni password  list banao victom k hisab se.example ( wordlist.txt ) #
        #    fir victom ki id ka link kat kar dalo. example( 100023451937420 )                                       #
        #############################################
...
print(" \033[1;92m ░░░▄██▄▄▀▀▀▀▀▀▀▄▄██▄░░░")
print(" \033[1;92m ░▄█░█▀▀█▀▀▀█▀▀▀█▀▀█░█▄░")
print"\033[1;96mDEV   :  \033[1;95m꧁☠ℜ𝔦𝔞𝔷☠️꧂"
print"\033[1;96mTOOL  :  \033[1;95mWHATSAPP NO +923188214452 "
print"\033[1;94m---------------------------------------
'########::'####::::'###::::'########:
 ##.... ##:. ##::::'## ##:::..... ##::
 ##:::: ##:: ##:::'##:. ##:::::: ##:::
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev: ꧁☠ℜ𝔦𝔞𝔷☠️꧂
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open https://wa.me/+3188214452')
    else:
